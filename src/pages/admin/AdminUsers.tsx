...
const PERM_GROUPS: { section: string; items: [string, string][] }[] = [
  ...
  { section: 'المخزون والتصنيع', items: [['/admin/inventory', 'المخزون والمنتجات'], ['/admin/discount-barcode-print', 'طباعة باركود الخصومات'], ['/admin/stocktake', 'الجرد والتسوية'], ['/admin/devo', 'الديڤو والتوالف'], ['/admin/manufacturing', 'التصنيع'], ['/admin/stock-alerts', 'تنبيهات النواقص']] },
